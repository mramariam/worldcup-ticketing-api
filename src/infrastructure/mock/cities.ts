...
//Mexique
export const Guadalajara = new City(countries[1], "Guadalajara");
export const MexicoCity = new City(countries[1], "Mexico City");
export const Monterrey = new City(countries[1], "Monterrey");
//Canada
export const Vancouver = new City(countries[2], "Vancouver");
export const Toronto = new City(countries[2], "Toronto");
